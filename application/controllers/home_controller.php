 ...
 */
 class Home_controller extends CI_Controller{
   ...
   public function HRsearch(){ // search function starts                         
       ...
       $data['query'] = $this->employee_model->HRsearch($emp_no,$birth_date,$first_name,$last_name,$dept_no,$title,$limit);
       }
       
       $data['query'] = $this->employee_model->HRsearch($emp_no,$birth_date,$first_name,$last_name,$dept_no,$title,$limit);
       $this->load->view('hr_view', $data);    // opens the employee view
   }
   
   public function add_post(){
       
       $this->load->view('add_emp_view');     // opens the add employee view
